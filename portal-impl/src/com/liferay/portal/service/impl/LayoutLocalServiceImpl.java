...
public class LayoutLocalServiceImpl extends LayoutLocalServiceBaseImpl {
	...
	/**
	 * Updates the layout replacing its style book entry ERC.
	 *
	 * @param      groupId the primary key of the group
	 * @param      privateLayout whether the layout is private to the group
	 * @param      layoutId the layout ID of the layout
	 * @param      styleBookEntryERC the external reference code of the style
	 *             book entry
	 * @return     the updated layout
	 * @throws     PortalException if a portal exception occurred
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link
	 *             #updateStyleBookEntryERC(long, boolean, long, String, String)}
	 */
	@Deprecated
	@Override
	public Layout updateStyleBookEntryERC(
		...
		return updateStyleBookEntryERC(
			groupId, privateLayout, layoutId, styleBookEntryERC, null);
	}
