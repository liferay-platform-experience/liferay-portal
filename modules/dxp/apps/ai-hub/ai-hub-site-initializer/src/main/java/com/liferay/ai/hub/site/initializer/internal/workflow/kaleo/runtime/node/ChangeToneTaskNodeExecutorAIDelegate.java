	...
	public void execute(
		...
		Assistant assistant = AiServices.builder(
			...
			object -> StringBundler.concat(
				...
				"adjust the tone of the provided text to be more ",
				workflowContext.get("tone"), ". Modify vocabulary, phrasing, ",
				"and sentence structure as needed while preserving the ",
				"original meaning, intent, and clarity. If the text already ",
				"matches this tone, return it unchanged. Output only the ",
