...
import com.liferay.portal.configuration.module.configuration.samples.TestConfiguration;
...
public class ConfigurationProviderTest {
	...
	public void testDeleteGroupConfiguration() throws Exception {
		...
		_configurationProvider.deleteGroupConfiguration(
			TestConfiguration.class, groupId1);

		Assert.assertEquals(
			1, _getFactoryConfigurationsCount(_PID, scope, null));

		_configurationProvider.deleteGroupConfiguration(
			TestConfiguration.class, groupId2);
	...
	private void _testSaveGroupConfiguration() throws Exception {
		...
		_configurationProvider.saveGroupConfiguration(
			TestConfiguration.class, groupId1, _properties);
		_configurationProvider.saveGroupConfiguration(
			TestConfiguration.class, groupId2, new HashMapDictionary<>());
