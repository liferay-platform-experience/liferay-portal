...
public class StyleBookEntryLocalServiceWrapper
	...
	public StyleBookEntry addStyleBookEntryFrontendToken(
		...
		return _styleBookEntryLocalService.addStyleBookEntryFrontendToken(
	...
	public String generateStyleBookEntryName(long groupId, String name) {
		return _styleBookEntryLocalService.generateStyleBookEntryName(
			groupId, name);
	}
...
// LIFERAY-SERVICE-BUILDER-HASH:406749744