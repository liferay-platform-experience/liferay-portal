...
public class StyleBookEntryServiceHttp {
	...
	public static com.liferay.style.book.model.StyleBookEntry addFrontendToken(
			...
			String cssVariableMappingValue, String editorType,
			...
			String frontendTokenSetName, String value,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				...
				editorType, frontendTokenCategoryName, frontendTokenDescription,
				frontendTokenLabel, frontendTokenName,
				frontendTokenSetDescription, frontendTokenSetLabel,
				frontendTokenSetName, value, serviceContext);
...
// LIFERAY-SERVICE-BUILDER-HASH:581845818