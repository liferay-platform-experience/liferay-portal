...
create unique index IX_EE81BDE3 on StyleBookTokenSet (styleBookEntryId, frontendTokenCategoryName[$COLUMN_LENGTH:75$], name[$COLUMN_LENGTH:75$], themeId[$COLUMN_LENGTH:255$], ctCollectionId);
