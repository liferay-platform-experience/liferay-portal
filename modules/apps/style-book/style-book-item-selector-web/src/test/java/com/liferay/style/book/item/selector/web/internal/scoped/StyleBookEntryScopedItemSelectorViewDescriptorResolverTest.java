...
public class StyleBookEntryScopedItemSelectorViewDescriptorResolverTest {
	...
	public void testResolve() throws Exception {
		...
		_withResolver(
			true,
			this::_testResolveReturnsLayoutDefaultWhenLevelKeyUnknown);
		_withResolver(
			true,
			this::_testResolveReturnsLayoutDefaultWhenScopeKeyUnknown);
		_withResolver(
			true,
			this::_testResolveReturnsLayoutDefaultWhenEntriesGroupNotConnected);
		_withResolver(
			true, this::_testResolveReturnsEntriesWhenGroupConnected);
	}
