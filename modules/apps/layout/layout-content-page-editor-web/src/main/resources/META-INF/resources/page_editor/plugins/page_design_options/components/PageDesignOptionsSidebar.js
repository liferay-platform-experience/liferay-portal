...
import MasterLayoutPageDesignOptionsList from './MasterLayoutPageDesignOptionsList';
import StyleBookPageDesignOptionsList from './StyleBookPageDesignOptionsList';
	...
	const tabs = useMemo(() => {
		...
		if (config.layoutType !== LAYOUT_TYPES.master) {
			result.push({
				...
				render: () => (
					<MasterLayoutPageDesignOptionsList
						masterLayoutPageTemplateEntryERC={
							masterLayoutPageTemplateEntryERC
						}
		...
		result.push({
			...
			render: () => (
				<StyleBookPageDesignOptionsList
