...
import ChatShell from '../../../src/main/resources/META-INF/resources/ai-assistant-chat';
	...
	return (
		...
		>
			<ChatShell>
				...
				<ChatShell.Body>Chat Content</ChatShell.Body>
			</ChatShell>
		</ChatFloatingContainer>
	);
}
...
describe('ChatFloatingContainer', () => {
	...
	it('renders a named drag handle for repositioning the panel', () => {
		renderContainer();

		expect(
			screen.getByRole('button', {name: 'move-assistant'})
		).toBeInTheDocument();
	});

	it('renders a named resize handle for resizing the panel', () => {
		renderContainer();
