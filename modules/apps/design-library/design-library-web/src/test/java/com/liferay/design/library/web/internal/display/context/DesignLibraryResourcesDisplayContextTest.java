...
public class DesignLibraryResourcesDisplayContextTest {
	...
	public void testGetAPIURL() throws Exception {
		...
		Assert.assertTrue(
			url, url.contains(FragmentCollection.class.getName()));
		Assert.assertTrue(
			url, url.contains(String.valueOf(depotEntry.getGroupId())));
		Assert.assertTrue(url, url.contains(StyleBookEntry.class.getName()));
	}
	...
	public void testGetFDSActionDropdownItems() throws Exception {
		...
		_assertFDSActionDropdownItem(
			fdsActionDropdownItems.get(0), FragmentCollection.class.getName(),
			"edit", "link");
		_assertFDSActionDropdownItem(
			fdsActionDropdownItems.get(1), StyleBookEntry.class.getName(),
			"edit", "link");
		_assertFDSActionDropdownItem(
			fdsActionDropdownItems.get(2), FragmentCollection.class.getName(),
			"view", "link");
		_assertFDSActionDropdownItem(
			fdsActionDropdownItems.get(3), FragmentCollection.class.getName(),
			"delete", "async");
		_assertFDSActionDropdownItem(
			fdsActionDropdownItems.get(4), StyleBookEntry.class.getName(),
			"delete", "async");
	...
	private void _assertFDSActionDropdownItem(
		...
		String expectedEntryClassName, String expectedId,
