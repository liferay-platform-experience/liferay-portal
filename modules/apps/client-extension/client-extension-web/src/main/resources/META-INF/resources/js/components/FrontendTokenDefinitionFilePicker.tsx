...
const FrontendTokenDefinitionFilePicker = ({
	...
	return (
		<LearnResourcesContext.Provider value={learnResources}>
			...
			>
				{`${Liferay.Language.get(
					'the-frontend-token-definition-is-a-json-file-that-allows-you-to-contribute-your-own-tokens-it-will-replace-the-current-tokens-contributed-by-the-theme'
				)} `}
