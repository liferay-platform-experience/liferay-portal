...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {assetLibraryAssetEntries(assetLibraryId: ___, className: ___, classTypeId: ___, groupIds: ___, page: ___, pageSize: ___, search: ___, showNonindexable: ___, showScheduled: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
	...
	public AssetEntryPage assetLibraryAssetEntries(
			@GraphQLName("assetLibraryId") @NotEmpty String assetLibraryId,
			@GraphQLName("className") String[] className,
			@GraphQLName("classTypeId") Long classTypeId,
			@GraphQLName("groupIds") Long[] groupIds,
			@GraphQLName("search") String search,
			@GraphQLName("showNonindexable") Boolean showNonindexable,
			@GraphQLName("showScheduled") Boolean showScheduled,
		...
		return _applyComponentServiceObjects(
			...
			assetEntryResource -> new AssetEntryPage(
				assetEntryResource.getAssetLibraryAssetEntriesPage(
					Long.valueOf(assetLibraryId), className, classTypeId,
					groupIds, search, showNonindexable, showScheduled,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {assetEntries(className: ___, classTypeId: ___, groupIds: ___, page: ___, pageSize: ___, search: ___, showNonindexable: ___, showScheduled: ___, siteKey: ___, sorts: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField(
		...
		return _applyComponentServiceObjects(
			...
			assetEntryResource -> new AssetEntryPage(
				assetEntryResource.getSiteAssetEntriesPage(
					Long.valueOf(siteKey), className, classTypeId, groupIds,
					search, showNonindexable, showScheduled,
					Pagination.of(page, pageSize),
					_sortsBiFunction.apply(assetEntryResource, sortsString))));
	}
...
// LIFERAY-REST-BUILDER-HASH:861020650