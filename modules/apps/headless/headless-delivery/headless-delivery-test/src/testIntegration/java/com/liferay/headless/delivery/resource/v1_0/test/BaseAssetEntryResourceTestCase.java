...
public abstract class BaseAssetEntryResourceTestCase {
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPage() throws Exception {
		Long assetLibraryId =
			testGetAssetLibraryAssetEntriesPage_getAssetLibraryId();
		Long irrelevantAssetLibraryId =
			testGetAssetLibraryAssetEntriesPage_getIrrelevantAssetLibraryId();

		Page<AssetEntry> page =
			assetEntryResource.getAssetLibraryAssetEntriesPage(
		...
		if (irrelevantAssetLibraryId != null) {
			AssetEntry irrelevantAssetEntry =
				testGetAssetLibraryAssetEntriesPage_addAssetEntry(
					irrelevantAssetLibraryId, randomIrrelevantAssetEntry());

			page = assetEntryResource.getAssetLibraryAssetEntriesPage(
				irrelevantAssetLibraryId, null, null, null, null, null, null,
				Pagination.of(1, (int)totalCount + 1), null);

			Assert.assertEquals(totalCount + 1, page.getTotalCount());

			assertContains(
				irrelevantAssetEntry, (List<AssetEntry>)page.getItems());
			assertValid(
				page,
				testGetAssetLibraryAssetEntriesPage_getExpectedActions(
					irrelevantAssetLibraryId));
		}

		AssetEntry assetEntry1 =
			testGetAssetLibraryAssetEntriesPage_addAssetEntry(
				assetLibraryId, randomAssetEntry());
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPageWithPagination()
		throws Exception {
		...
		Page<AssetEntry> assetEntriesPage =
			assetEntryResource.getAssetLibraryAssetEntriesPage(
				assetLibraryId, null, null, null, null, null, null, null, null);
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPageWithSortDateTime()
		throws Exception {

		testGetAssetLibraryAssetEntriesPageWithSort(
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetAssetLibraryAssetEntriesPageWithSortString()
		throws Exception {
	...
	protected void testGetAssetLibraryAssetEntriesPageWithSort(
		...
		assetEntry1 = testGetAssetLibraryAssetEntriesPage_addAssetEntry(
			assetLibraryId, assetEntry1);

		assetEntry2 = testGetAssetLibraryAssetEntriesPage_addAssetEntry(
			assetLibraryId, assetEntry2);
	...
	protected Long testGetAssetLibraryAssetEntriesPage_getAssetLibraryId()
		throws Exception {
	...
	@Test
	public void testGetSiteAssetEntriesPage() throws Exception {
		Long siteId = testGetSiteAssetEntriesPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteAssetEntriesPage_getIrrelevantSiteId();
		...
		if (irrelevantSiteId != null) {
			AssetEntry irrelevantAssetEntry =
				testGetSiteAssetEntriesPage_addAssetEntry(
					irrelevantSiteId, randomIrrelevantAssetEntry());

			page = assetEntryResource.getSiteAssetEntriesPage(
			...
			assertValid(
				page,
				testGetSiteAssetEntriesPage_getExpectedActions(
					irrelevantSiteId));
		}

		AssetEntry assetEntry1 = testGetSiteAssetEntriesPage_addAssetEntry(
			siteId, randomAssetEntry());

		AssetEntry assetEntry2 = testGetSiteAssetEntriesPage_addAssetEntry(
			siteId, randomAssetEntry());
		...
		assertContains(assetEntry2, (List<AssetEntry>)page.getItems());
		assertValid(
			page, testGetSiteAssetEntriesPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteAssetEntriesPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteAssetEntriesPageWithPagination() throws Exception {
		Long siteId = testGetSiteAssetEntriesPage_getSiteId();

		Page<AssetEntry> assetEntriesPage =
			assetEntryResource.getSiteAssetEntriesPage(
		...
		AssetEntry assetEntry3 = testGetSiteAssetEntriesPage_addAssetEntry(
			siteId, randomAssetEntry());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<AssetEntry> page1 = assetEntryResource.getSiteAssetEntriesPage(
			...
			Page<AssetEntry> page2 = assetEntryResource.getSiteAssetEntriesPage(
				siteId, null, null, null, null, null, null,
				Pagination.of(
					(int)Math.ceil((totalCount + 2.0) / pageSizeLimit),
					pageSizeLimit),
			...
			Page<AssetEntry> page3 = assetEntryResource.getSiteAssetEntriesPage(
				siteId, null, null, null, null, null, null,
				Pagination.of(
					(int)Math.ceil((totalCount + 3.0) / pageSizeLimit),
					pageSizeLimit),
	...
	@Test
	public void testGetSiteAssetEntriesPageWithSortDateTime() throws Exception {
		testGetSiteAssetEntriesPageWithSort(
			EntityField.Type.DATE_TIME,
			(entityField, assetEntry1, assetEntry2) -> {
				BeanTestUtil.setProperty(
					assetEntry1, entityField.getName(),
	...
	@Test
	public void testGetSiteAssetEntriesPageWithSortDouble() throws Exception {
		testGetSiteAssetEntriesPageWithSort(
			EntityField.Type.DOUBLE,
			(entityField, assetEntry1, assetEntry2) -> {
				BeanTestUtil.setProperty(
	...
	@Test
	public void testGetSiteAssetEntriesPageWithSortInteger() throws Exception {
		testGetSiteAssetEntriesPageWithSort(
			EntityField.Type.INTEGER,
			(entityField, assetEntry1, assetEntry2) -> {
				BeanTestUtil.setProperty(assetEntry1, entityField.getName(), 0);
	...
	@Test
	public void testGetSiteAssetEntriesPageWithSortString() throws Exception {
		testGetSiteAssetEntriesPageWithSort(
			EntityField.Type.STRING,
			(entityField, assetEntry1, assetEntry2) -> {
				Class<?> clazz = assetEntry1.getClass();
	...
	protected void testGetSiteAssetEntriesPageWithSort(
			EntityField.Type type,
			UnsafeTriConsumer<EntityField, AssetEntry, AssetEntry, Exception>
				unsafeTriConsumer)
		throws Exception {
		...
		assetEntry1 = testGetSiteAssetEntriesPage_addAssetEntry(
			siteId, assetEntry1);

		assetEntry2 = testGetSiteAssetEntriesPage_addAssetEntry(
			siteId, assetEntry2);
	...
	protected Long testGetSiteAssetEntriesPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteAssetEntriesPage_getIrrelevantSiteId()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-1179295952