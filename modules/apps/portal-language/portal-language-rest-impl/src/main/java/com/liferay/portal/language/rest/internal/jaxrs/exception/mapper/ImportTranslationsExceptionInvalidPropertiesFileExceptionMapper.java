...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Portal.Language.REST.ImportTranslationsExceptionInvalidPropertiesFileExceptionMapper"
	},
	service = ExceptionMapper.class
)
public class ImportTranslationsExceptionInvalidPropertiesFileExceptionMapper
	extends BaseExceptionMapper
		<ImportTranslationsException.InvalidPropertiesFile> {
	...
	protected Problem getProblem(
		...
		return new Problem(
			...
			null,
			ImportTranslationsException.InvalidPropertiesFile.class.getName());
	}
