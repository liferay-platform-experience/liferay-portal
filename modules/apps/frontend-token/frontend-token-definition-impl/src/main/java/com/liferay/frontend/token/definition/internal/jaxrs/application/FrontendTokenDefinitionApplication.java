...
public class FrontendTokenDefinitionApplication extends Application {
	...
	@Path("/tokens-info")
	@POST
	public Response getFrontendTokenDefinitionTokensInfo(
		...
		FrontendTokenDefinition frontendTokenDefinition =
			_frontendTokenDefinitionRegistry.getFrontendTokenDefinition(
				companyId, externalReferenceCode, null);

		if (frontendTokenDefinition != null) {
			return _getFrontendTokenDefinitionTokensInfo(
				_portal.getLocale(httpServletRequest), frontendTokenDefinition);
		}
	...
	public Response validateFrontendTokenDefinitionFile(
		...
		try {
			return _validateFrontendTokenDefinitionFile(
			...
			return _getResponse(
				_language.get(
					locale,
					"your-upload-failed-to-complete-please-try-again-or-" +
	...
	private Response _getFrontendTokenDefinitionTokensInfo(
		Locale locale, FrontendTokenDefinition frontendTokenDefinition) {
	...
	private Response _validateFrontendTokenDefinitionFile(
		...
		if (file.exists()) {
			frontendTokenDefinitionJSONString = new String(
		...
		return _getFrontendTokenDefinitionTokensInfo(
			locale, frontendTokenDefinition);
	}
