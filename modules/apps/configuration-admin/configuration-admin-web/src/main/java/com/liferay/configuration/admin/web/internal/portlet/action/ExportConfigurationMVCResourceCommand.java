...
public class ExportConfigurationMVCResourceCommand
	...
	protected Dictionary<String, Object> getProperties(
			Serializable companyId, String languageId, String factoryPid,
				...
				for (ConfigurationModel factoryInstancesConfigurationModel :
					...
					zipWriter.addEntry(
						...
						ConfigurationExporter.getPropertiesAsBytes(
							getProperties(
								themeDisplay.getCompanyId(), languageId,
	...
	private void _exportFactoryPid(
		...
		for (ConfigurationModel factoryInstancesConfigurationModel :
			...
			zipWriter.addEntry(
				...
				ConfigurationExporter.getPropertiesAsBytes(
					getProperties(
						themeDisplay.getCompanyId(), languageId, factoryPid,
	...
	private void _exportPid(
		...
		PortletResponseUtil.sendFile(
			...
			ConfigurationExporter.getPropertiesAsBytes(
				getProperties(
					themeDisplay.getCompanyId(), languageId, factoryPid, pid,
					configurationScopeDisplayContext.getScope(),
					configurationScopeDisplayContext.getScopePK())),
