...
@Component(
	property = {
		...
		"panel.category.order:Integer=1000"
	},
	service = PanelCategory.class
)
public class ApplicationsPersonalizationPanelCategory
	extends BasePanelCategory {

	@Override
	public String getKey() {
		return PanelCategoryKeys.APPLICATIONS_MENU_APPLICATIONS_PERSONALIZATION;
	}
