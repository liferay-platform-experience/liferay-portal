...
@Component(
	property = {
		...
		"mvc.command.name=/omni_search/omni_search_content"
	},
	service = MVCResourceCommand.class
)
public class OmniSearchContentMVCResourceCommand
	...
	protected void doServeResource(
		...
		if (!FeatureFlagManagerUtil.isEnabled(
			...
			!themeDisplay.isSignedIn() || Validator.isNull(keywords)) {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OmniSearchContentMVCResourceCommand.class);
