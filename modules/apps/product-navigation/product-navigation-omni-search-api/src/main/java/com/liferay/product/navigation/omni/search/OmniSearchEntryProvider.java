...
/**
 * Contributes entries to the Omni Search modal in the control menu. Register
 * implementations as OSGi components; Omni Search aggregates every
 ...
 */
public interface OmniSearchEntryProvider {
