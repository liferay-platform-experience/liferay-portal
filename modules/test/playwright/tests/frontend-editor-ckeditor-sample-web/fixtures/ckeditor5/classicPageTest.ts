		...
		classicPage: async ({ckeditorSamplePage}, use) => {
			const classicPage: ClassicPage =
				await ckeditorSamplePage.gotoTab(
					TabName.CK_EDITOR_5, subTabName
				);
...
const reactPlusCETClassicPageTest = classicPageTestFor(SubTabName.REACT_PLUS_CET);

export {
	advancedClassicPageTest, basicClassicPageTest, reactClassicPageTest,
